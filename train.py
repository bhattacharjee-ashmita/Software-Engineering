...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET",font=("times new roman",25,"bold"),bg="white",fg="dark blue")
        title_lbl.place(x=0,y=0,width=1530,height=45)


        img_top=Image.open(r"collage_images\Train_Banner.jpg")
        ...
        img_bottom=Image.open(r"collage_images\Train_Banner1.jpg")
